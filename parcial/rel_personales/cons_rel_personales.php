    ...
    <div class="container " style="text-align:center">
        ...
        <div class="form-row">
            ...
            <div class="col-10">
                ...
                <form name="formulario" action="procesos_rel_personales/actualizar.php?ida=<?php echo $key['id'];?>" method="POST" class="needs-validation"
                    novalidate>
                    <?php  include("form_cons_rel_personales.php");?>                   
                </form> <br>
            </div>
        </div>
    </div>
