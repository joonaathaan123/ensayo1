...
<div class="form-row">
    ...
    <div class="col-md-4 mb-3">
        ...
        <input type="text" class="form-control" name="identificacion" placeholder="Nº De Identificacion" value="<?php echo $key['numeroid']; ?>" required>
    </div>

    <div class="col-md-4 mb-3">
        <label>Nombres</label>
        <input type="text" class="form-control" name="nombres" placeholder="Nombre" value="<?php echo $key['nombres']; ?>" required>
    </div>

    <div class="col-md-4 mb-3">
        <label>Apellidos</label>
        <input type="text" class="form-control" name="apellidos" placeholder="Apellidos" value="<?php echo $key['apellidos']; ?>" required>
    </div>
...
<div class="form-group row">
    ...
    <div class="col-10">
        <textarea type="text" class="form-control" name="observaciones" placeholder="Observaciones" rows="3" required><?php echo $key['observaciones']; ?></textarea>
    </div>
</div>
...
<div class="form-group row">
    ...
    <div class="col-10">
        <textarea type="text" class="form-control" name="hisoria" placeholder="Historia Escolar" rows="3" required><?php echo $key['historia_escol']; ?></textarea>
    </div>
</div>
<div class="form-group row">
    ...
    <div class="col-10">
        <textarea type="text" class="form-control" name="habitos" placeholder="Habitos De Estudios y Dif. Academica"
            rows="3" required><?php echo $key['habitos_estu']; ?></textarea>
    </div>
</div><br>
