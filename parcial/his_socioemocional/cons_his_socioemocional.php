<?php 
    ...
    $sql="SELECT id,
				...
				antecedente_salud,
				antecedente_ap
            from historial_socioemocional where id='$id'";
...
<body>
    ...
    <div class="container " style="text-align:center">
        <div class="form-row">
            ...
            <div class="col-10">
                <form name="formulario" action="procesos_his_socioemocional/actualizar.php?ida=<?php echo $key['id'];?>"
                    method="POST" class="needs-validation" novalidate>
                    <?php  include("form_cons_his_socioemocional.php");?>
                </form> <br>
            </div>
        </div>
    </div>
