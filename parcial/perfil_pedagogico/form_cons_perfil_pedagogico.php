...
<div class="form-row">
    ...
    <div class="col-sm-10">
        <textarea type="text" class="form-control" name="socioafectiva" placeholder="Socioafectiva" rows="3" required><?php echo $key['socioafectiva']; ?></textarea>
    </div>
</div> <br>
...
<div class="form-row">
    ...
    <div class="col-sm-10">
        <textarea type="text" class="form-control" name="cognitiva" placeholder="Cognitiva" rows="3" required><?php echo $key['cognitiva']; ?></textarea>
    </div>
</div> <br>
...
<div class="form-row">
    ...
    <div class="col-sm-10">
        <textarea type="text" class="form-control" name="comunicacion" placeholder="Comunicación" rows="3" required><?php echo $key['comunicacion']; ?></textarea>
    </div>
</div> <br>
...
<div class="form-row">
    ...
    <div class="col-sm-10">
        <textarea type="text" class="form-control" name="moral" placeholder="Moral Y Espiritual" rows="3" required><?php echo $key['moral']; ?></textarea>
    </div>
</div><br>
<div class="form-row">
    ...
    <div class="col-md-6 mb-3">
        ...
        <textarea type="text" class="form-control" name="fortalezas" placeholder="Fortalezas" rows="3" required><?php echo $key['fortalezas']; ?></textarea>
    </div>

    <div class="col-md-6 mb-3">
        <label>Debilidades</label>
        <textarea type="text" class="form-control" name="debilidades" placeholder="Debilidades" rows="3" required><?php echo $key['debilidades']; ?></textarea>
    </div>
...
<div class="form-row">
    ...
    <div class="col-sm-10">
        <textarea type="text" class="form-control" name="barreras" placeholder="Barreras En EL Aprendizaje" rows="3"
            required><?php echo $key['barreras']; ?></textarea>
    </div>
...
<div class="form-row">
    ...
    <div class="col-sm-10">
        <textarea type="text" class="form-control" name="estrategias" placeholder="Estrategias Utilizadas En El Aula"
            rows="3" required><?php echo $key['estrategias']; ?></textarea>
    </div>
